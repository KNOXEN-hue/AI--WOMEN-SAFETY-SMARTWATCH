...
const products = [
  ...
  { id: "safeguard-pro", name: "SafeGuard AI Pro", price: 2000, originalPrice: 9999, desc: "Complete safety suite with AI and defense modules.", features: ["Everything in Lite", "Pepper Spray Module", "Electric Shock", "AI Threat Detection", "4G LTE"], badge: "Best Seller" },
  { id: "safeguard-ultra", name: "SafeGuard Ultra", price: 2000, originalPrice: 14999, desc: "Premium edition with advanced AI and extended battery.", features: ["Everything in Pro", "Facial Recognition", "Voice Activation", "7-day Battery", "Titanium Build"] },
];
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    {[
                      ...
                      { feature: "Pepper Spray Module", lite: false, pro: true, ultra: true },
